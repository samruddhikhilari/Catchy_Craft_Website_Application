      ...
      <img src="./logo/logo.jpg" alt="">
        ...
        <div class="login-form-container">
            ...
            <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" name="forget_page" method="post">
                ...
                <h3 style="right: 0%;">Reset Admin Password</h3>
				...
				<p><a href="../index_admin.php" class="btn" style="text-decoration:none; color:white;">Next</a></p>
                <p>Login<a href="admin_login.php">  click here </a></p>
