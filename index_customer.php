      ...
      <div class="header-main">
          ...
          <div class="container">
            ...
            <div class="header-user-actions">
              ...
              <button class="action-btn">
                <a href="user/index.html"><ion-icon name="person-outline" class="menu-title"></ion-icon></a>
              </button> 
        ...
        <nav class="desktop-navigation-menu">
          ...
          <div class="container">
            ...
            <ul class="desktop-menu-category-list">
              ...
              <li class="menu-category">
                <a href="#" class="menu-title"> Decoration</a>
        ...
        <nav class="mobile-navigation-menu  has-scrollbar" data-mobile-menu>
          ...
          <li class="menu-category">
              ...
              <a href="./Details/sign_in.html" class="menu-title">Profile</a> 
          ...
          <ul class="mobile-menu-category-list">
            ...
            <li class="menu-category">
              ...
              <ul class="submenu-category-list" data-accordion>
                ...
                <li class="submenu-category">
                  <a href="shirt.html" class="submenu-title">Shirt</a>
                </li>
    
                <li class="submenu-category">
                  <a href="jeans.html" class="submenu-title"> Jeans</a>
                </li>
    
                <li class="submenu-category">
                  <a href="footware.html" class="submenu-title"> Shoes</a>
                </li>
            ...
            <li class="menu-category">
              ...
              <ul class="submenu-category-list" data-accordion>
                ...
                <li class="submenu-category">
                  <a href="womens_cloths.html" class="submenu-title">Dresses</a>
                </li>
    
                <li class="submenu-category">
                  <a href="footware.html" class="submenu-title">Foot Wears </a>
                </li>
    
                <li class="submenu-category">
                  <a href="Jewellery.html" class="submenu-title">Jewellery</a>
                </li>
    
                <li class="submenu-category">
                  <a href="bags.html" class="submenu-title"> Bags</a>
                </li>
            ...
            <ul class="sidebar-menu-category-list">
              ...
              <li class="sidebar-menu-category">
                ...
                <button class="sidebar-accordion-menu" data-accordion-btn>
                  ...
                  <div class="menu-title-flex">
                    <img src="products/clothes.jpg" alt="clothes" width="20" height="20"
                ...
                <ul class="sidebar-submenu-category-list" data-accordion>
                  ...
                  <li class="sidebar-submenu-category">
                    <a href="shirt.html" class="sidebar-submenu-title">
                  ...
                  <li class="sidebar-submenu-category">
                    <a href="jeans.html" class="sidebar-submenu-title">
                  ...
                  <li class="sidebar-submenu-category">
                    <a href="jacket.html" class="sidebar-submenu-title">
                  ...
                  <li class="sidebar-submenu-category">
                    <a href="long_dress.html" class="sidebar-submenu-title">
                      <p class="product-name">long dress</p>
              ...
              <li class="sidebar-menu-category">
                ...
                <button class="sidebar-accordion-menu" data-accordion-btn>
                  ...
                  <div class="menu-title-flex">
                    <img src="products/shoes.jpg" alt="footwear" class="menu-title-img" width="20"
                      height="20">
                ...
                <ul class="sidebar-submenu-category-list" data-accordion>
                  ...
                  <li class="sidebar-submenu-category">
                    <a href="formal.html" class="sidebar-submenu-title">
                  ...
                  <li class="sidebar-submenu-category">
                    <a href="casual.html" class="sidebar-submenu-title">
              ...
              <li class="sidebar-menu-category">
                ...
                <button class="sidebar-accordion-menu" data-accordion-btn>
                  ...
                  <div class="menu-title-flex">
                    <img src="products/jwellery1.jpg" alt="clothes" class="menu-title-img" width="20"
                      height="20">

                    <p class="menu-title">Jewellry</p>
                  </div>
                ...
                <ul class="sidebar-submenu-category-list" data-accordion>
                  ...
                  <li class="sidebar-submenu-category">
                    <a href="Jewellery.html" class="sidebar-submenu-title">
                  ...
                  <li class="sidebar-submenu-category">
                    <a href="#" class="sidebar-submenu-title">
                      <p class="product-name">Sporches</p>
              ...
              <li class="sidebar-menu-category">
                ...
                <button class="sidebar-accordion-menu" data-accordion-btn>
                  ...
                  <div class="menu-title-flex">
                    <img src="products/sofa.jpg" alt="perfume" class="menu-title-img" width="20"
                      height="20">

                    <p class="menu-title">Furnitures</p>
                  </div>
                ...
                <ul class="sidebar-submenu-category-list" data-accordion>
                  ...
                  <li class="sidebar-submenu-category">
                    <a href="tables.html" class="sidebar-submenu-title">
                      <p class="product-name">Dinning Tables</p>
